...
#plotting bmi vs. age for only stroke patients
plt.figure(figsize=(8, 6))
sns.scatterplot(x='age', y='bmi', data=stroke_positive, hue
='stroke')
plt.title('BMI vs. Age for Stroke Patients')
plt.show()

#show whether there is a correlation between bmi and age for stroke patients
correlation = stroke_positive['age'].corr(stroke_positive['bmi'])
print("Correlation between age and bmi for stroke patients:", correlation)

#what does the correlation mean?
if correlation > 0:
    print("There is a positive correlation between age and bmi for stroke patients.")
elif correlation < 0:
    print("There is a negative correlation between age and bmi for stroke patients.")
